...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefirx="sql" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>

<sql:query var = "rs" dataSource="jdbc:mysql://35.225.0.199:3306/wppone">
...
<div style="margin-left: 100px; margin-right: 100px;" id="content" class="content">
    ...
    <div>
        ...
        <div class="sub7_tab_menu" style="">
            ...
            <a class="sub7_tab" href="http://localhost:8080/WP2_project1_war_exploded/form.jsp" style="display: inline-block;">서식</a>
